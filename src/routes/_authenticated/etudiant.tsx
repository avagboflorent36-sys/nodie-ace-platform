...
import { Home, GraduationCap, Video, Award, LifeBuoy, Wallet, User } from "lucide-react";
...
const items = [
  ...
  { title: "Paiements", url: "/etudiant/paiements", icon: Wallet },
  { title: "Certificat", url: "/etudiant/certificat", icon: Award },
  { title: "Profil", url: "/etudiant/profil", icon: User },
